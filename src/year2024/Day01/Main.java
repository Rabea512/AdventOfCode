...
public class Main {
    public static void main(String[] args) throws IOException {
        System.out.println(part1("/Users/degroot/Privat/AdventOfCode/src/year2024/Day01/input_test.txt"));
        System.out.println(part1("/Users/degroot/Privat/AdventOfCode/src/year2024/Day01/input01.txt"));

        System.out.println(part2("/Users/degroot/Privat/AdventOfCode/src/year2024/Day01/input_test.txt"));
        System.out.println(part2("/Users/degroot/Privat/AdventOfCode/src/year2024/Day01/input02.txt"));
    }
    ...
    public static Input readInput(String path) throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(
            ...
            while (line != null && !line.isEmpty()) {
                final String[] leftRight = line.split("\\s+");
